...
class DeviceListAdapter(
    ...
    inner class VH(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val tvAccessibility: TextView   = view.findViewById(R.id.tvAccessibilityStatus)
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        if (device.accessibilityGranted) {
            holder.tvAccessibility.text      = "📸 Screenshot: READY"
            holder.tvAccessibility.setTextColor(Color.parseColor("#2E7D32"))
            holder.tvAccessibility.visibility = View.VISIBLE
        } else {
            holder.tvAccessibility.text      = "⚠️ Accessibility OFF — Screenshot kaam nahi karega"
            holder.tvAccessibility.setTextColor(Color.parseColor("#E65100"))
            holder.tvAccessibility.visibility = View.VISIBLE
        }
